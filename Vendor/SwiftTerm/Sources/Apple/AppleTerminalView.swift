...
extension TerminalView {
    ...
    func mapColor (color: Attribute.Color, isFg: Bool, isBold: Bool, useBrightColors: Bool = true) -> TTColor
    {
        ...
        case .defaultInvertedColor:
            // PATCH (imperator-finder-terminal): reverse video swaps the default
            // colours, it does not invert them per channel. Upstream returned
            // inverseColor(), which turns Terminal.app's green-on-black into
            // magenta-on-white for anything using SGR 7 with default colours
            // (zsh's paste highlight, less/man status lines, vim visual mode).
            // Terminal.app and xterm both swap. See Vendor/SwiftTerm/README.md.
